...
public class ComputeEngineSample {
   ...
   */
  private static final String APPLICATION_NAME = "apache-web-server";

  /** Set projectId to your Project ID from Overview pane in the APIs console */
  private static final String projectId = "winter-gear-153308";

  /** Set Compute Engine zone */
  private static final String zoneName = "asia-east1-c";
  ...
  /** OAuth 2.0 scopes */
  private static final List<String> SCOPES = Arrays.asList(ComputeScopes.DEVSTORAGE_FULL_CONTROL);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      Compute compute = new Compute.Builder(
       ...
       //System.out.println("zone list : "+compute.zones().list(projectId).execute());
       System.out.println("region list : "+compute.regions().list(projectId).execute().toPrettyString());
       
      // InstanceList list = instances.execute();
       //System.out.println("list : "+list.toPrettyString());

      Compute.TargetPools.List targetPools = compute.targetPools().list(projectId, "asia-east1");
      TargetPoolList list = targetPools.execute();
      System.out.println("targetpool list : "+list.toPrettyString());
  ...
  private static Credential authorize() throws Exception {
    ...
    GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(
        ...
        .build();
    // authorize
    System.out.println("clientSecrtes : "+clientSecrets.toPrettyString());
    return new AuthorizationCodeInstalledApp(flow, new LocalServerReceiver()).authorize("users");
  }
